        ...
        <div class="create-form">
            ...
            method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="productdescription" name="description" cols="50" rows="5" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Your description here"></textarea>
                    <br>
                    @error('description')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
